...
不管是单个文字水印、文字水印平铺，或是个性化logo，拍摄参数......watermarker专注于水印的处理，摒弃其它图片处理功能来追求轻量化。
通过安装包一键安装这款仅数MB大小的水印编辑器，调好您的水印参数，并导入所有照片一键应用水印。我们追求简洁、便利。
...
[![下载 Windows 安装包](https://img.shields.io/badge/下载-Windows%20安装包-brightgreen)](https://github.com/06FallingLight90/watermarker/releases/download/v0.4.3/Watermarker_0.4.2_x64-setup.exe)
